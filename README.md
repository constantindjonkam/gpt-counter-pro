...
This Chrome extension (works on all chromium browsers) tracks the number of requests made to specific models (`o1`, `o3-mini-high`, `gpt-4o` and `o3-mini`) on `chatgpt.com` and displays the usage count in a popup.
...
- Tracks requests to `o1`, `o3-mini-high`, `gpt-4o` and `o3-mini` models.
...
2. View the request counts for `o1`, `o3-mini-high`, `gpt-4o` and `o3-mini`.
